...
function convertDefinition(input) {
	const modelDefinition = input.default || input;
	// console.log(`convertDefinition`, modelDefinition);
	const schema = toSchema(
		modelDefinition.schema || modelDefinition.default || modelDefinition,
	);
	return schema;
}
