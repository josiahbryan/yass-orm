...
==============================
	 ...
	 */
	conn.create = function (tableAndIdField, fields, { allowBlankIdOnCreate } = {}) {
		...
		return this.search(table, fields, true)
			.then((ref) => {
				if (!ref) {
					...
					return this.create(tableAndIdField, fields, { allowBlankIdOnCreate });
				}
