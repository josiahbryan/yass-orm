...
const { LoadBalancerManager } = require('./load-balancing');
...
const {
	...
	readBalanceStrategy: configReadBalanceStrategy = 'round-robin',
} = config;

// Global cache for shared load balancer managers
