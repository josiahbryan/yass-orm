...
const defaultConfig = {
	...
	development: {
		...
		uuidLinkedIds: false,
		// OPT-IN (default OFF): give char(36) `t.linked` / `t.uuid` columns the SAME
		// collation as the uuid PRIMARY KEY (utf8mb4_bin) so cross-column JOINs stay
		// index-sargable. OFF = zero behavior change (no collation emitted).
...
if (process.argv[1] === __filename) {
	...
	console.log(jsonSafeStringify(configInstance, 0));
}
