...
export type ${baseName}Input = z.input<typeof ${baseName}Schema>;

/** Output type (what you get after parsing) */
export type ${baseName}Output = z.output<typeof ${baseName}Schema>;

/** Partial schema for updates */
export const ${baseName}PartialSchema = ${baseName}Schema.partial();
export type ${baseName}Partial = z.infer<typeof ${baseName}PartialSchema>;
`;
}
