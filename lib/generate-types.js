...
/**
 * Determine the output path for the .d.ts file.
 *
 * Always outputs to the defs/ folder (co-located with the schema definition).
 * This ensures types work correctly whether the model is JS or TS:
 * - JS models: import type from './defs/model-name'
 * - TS models: import type from './defs/model-name' (avoids .ts/.d.ts conflict)
 *
 * @param {string} definitionPath - Path to model definition .js file
 * @returns {string} Output path for the .d.ts file (always in defs/ folder)
 */
function determineOutputPath(definitionPath) {
	const resolvedPath = path.resolve(definitionPath);
	// Always output next to the definition file (in defs/ folder)
 ...
 *
 * Types are always output to the defs/ folder alongside the schema definition.
 * Models (JS or TS) import types from './defs/model-name'.
 *
 * @param {string} definitionPath - Path to model definition .js file
