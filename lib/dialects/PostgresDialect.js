...
/**
 * Longest identifier Postgres keeps: NAMEDATALEN - 1 (bytes). It truncates a
 * longer one with only a NOTICE.
 */
...
class PostgresDialect extends BaseDialect {
	...
	get maxIdentifierLength() {
		return POSTGRES_MAX_IDENTIFIER_LENGTH;
	}
...
module.exports = { PostgresDialect, POSTGRES_MAX_IDENTIFIER_LENGTH };
